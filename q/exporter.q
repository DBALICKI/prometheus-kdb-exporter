...
.prom.newmetric[`kdb_memory_heap_peak_bytes;`counter;();"maximum heap size so far"]
...
mem       :.prom.addmetric[`kdb_memory_usage_bytes;();();0f]
mem_heap  :.prom.addmetric[`kdb_memory_heap_bytes;();();0f]
mem_lim   :.prom.addmetric[`kdb_memory_heap_peak_bytes;();();0f]
mem_max   :.prom.addmetric[`kdb_memory_heap_limit_bytes;();();0f]
mem_map   :.prom.addmetric[`kdb_memory_mapped_bytes;();();0f]
mem_phys  :.prom.addmetric[`kdb_memory_physical_bytes;();();0f]
